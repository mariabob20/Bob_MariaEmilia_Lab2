...
namespace Bob_MariaEmilia_Lab2.Data
{
    public class Bob_MariaEmilia_Lab2Context : DbContext
    {
        ...
        public DbSet<Bob_MariaEmilia_Lab2.Models.Category>? Category { get; set; }

        public DbSet<Bob_MariaEmilia_Lab2.Models.Member>? Member { get; set; }

        public DbSet<Bob_MariaEmilia_Lab2.Models.Borrowing>? Borrowing { get; set; }
    }
}
